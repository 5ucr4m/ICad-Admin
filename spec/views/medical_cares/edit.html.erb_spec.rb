...
RSpec.describe("medical_cares/edit", type: :view) do
  before(:each) do
  ...
  it "renders the edit medical_care form" do
    render

    assert_select "form[action=?][method=?]", medical_care_path(@medical_care), "post" do
