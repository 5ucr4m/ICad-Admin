...
class User < ApplicationRecord
  ...
  delegate :on_administrative?, to: :current_company
  delegate :on_service?, to: :current_company
  ...
  def current_company
    user_roles.includes(:company).find_by(current_company: true) || user_roles.includes(:company).first
  end

  def current_role
    user_roles.find_by(company: current_company) || user_roles.first
  end
