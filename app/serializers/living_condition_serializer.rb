...
#
class LivingConditionSerializer < ActiveModel::Serializer
  attributes :id, :rooms, :residents, :electric_power, :slug

  has_one :water_supply
  has_one :rural_production_area
  has_one :garbage_disposal
  has_one :bathroom_drainage
  has_one :home_location
  has_one :home_wall_material
  has_one :home_situation
  has_one :home_access
  has_one :home_type
