...
ActiveRecord::Schema.define(version: 20_191_017_125_456) do
  ...
  create_table 'period_items', force: :cascade do |t|
    ...
    t.index %w[registrable_type registrable_id], name: 'index_period_items_on_registrable_type_and_registrable_id'
  ...
  create_table 'vaccination_items', force: :cascade do |t|
    ...
    t.index ['vaccination_id'], name: 'index_vaccination_items_on_vaccination_id'
  end
  ...
  add_foreign_key 'vaccination_items', 'vaccinations'
